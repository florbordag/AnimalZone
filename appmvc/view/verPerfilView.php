...
<html lang="en">
  <head>
    <title>Animal Zone - <?php echo '@'.$user->username.' - Ver Perfil de '.$amigo->NOMBRE.' '.$amigo->APELLIDO;?></title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
    ...
    <div class="row">
        <div class="d-none d-md-none d-xl-block">
            <div class="col">
                ...
                <img src="<?PHP echo $amigo->IMAGEN_PERFIL; ?>" class="card-img-top" alt="..." style="width:300px;height:300px;">
                <div class="card-body">
                    <h5 class="card-title"><?php echo $amigo->NOMBRE." ".$amigo->APELLIDO; ?></h5>
                    <p class="card-text"><?php echo $amigo->DESCRIPCION; ?></p>
                </div>
            ...
            <div class="card text-center " >
                ...
                <?php   if($post!=null){
                        ...
                        <div class="card mb-3">';
                            ...
                            <div class="row">
                                <div class="col-2">
                                    <img src="'.$amigo->IMAGEN_PERFIL.'" class="rounded-circle" alt="img_perfil" style="width:100px;height:100px; padding: 10px;">
                            ...
                            foreach($comentarios as $c){ echo $c->ID_COMENTARIOs;
                    ...
                    echo '</div>';}#fin de la card mb-3
                        } else {echo "Sorry! Este usuario no tiene post públicos que puedas ver.";}
                ?>
