    ...
    <a href="<?php echo $helper->url("Muro","cerrarSesion"); ?>"><button type="button" class="btn btn-dark btn-lg">Salir</button></a>
      <div class="card text-center">
        ...
        <div class="overflow-auto" style="height:40rem;">
          <form action="<?php  echo $helper->url("Moderador","moderar");?>" method="post">
                    <table class="table">
        ...
        <?PHP
        foreach($reportes as $rep){$visible; if($rep->PUBLICO==1){$visible='Público';}else {$visible='Amigos';}
        $estado; if($rep->ESTADO==1){$estado='Activo';}else {$estado='Inactivo';}
          echo '
                        <tr>
                            ...
                            <td>'.$visible.'</td> 
                            <td>'.$estado.'</td> 
                            <td><input type="checkbox" name="ids[]" value="'.$rep->ID_POST .'"></td>                             
                        </tr>
                  ';
          }
        ?>
     ...
     <input type="submit" name="activar" class="btn btn-success" value="Activar Post">
     <input type="submit" name="desactivar" class="btn btn-danger" value="Desactivar Post">
     </div>
     </form>
